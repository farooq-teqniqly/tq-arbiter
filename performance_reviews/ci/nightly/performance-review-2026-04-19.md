...
**Date**: 2026-04-19 22:48:12 UTC
**Baseline**: 2025-12-07T22:39:09.802928
**Commit**: 2582c991d1fc48881424fd52e526f25b91c3c059
...
|-----------|----------|---------|--------|--------|
| Ask_Query | 974.000 ns | 1335.100 ns | +37.1% | ⚠️ CRITICAL |
| Create_Command | 636.900 ns | 916.200 ns | +43.9% | ⚠️ CRITICAL |
| Create_Notification | 633.400 ns | 913.800 ns | +44.3% | ⚠️ CRITICAL |
| Create_Query | 633.000 ns | 913.200 ns | +44.3% | ⚠️ CRITICAL |
| Publish_Notification | 943.200 ns | 1336.900 ns | +41.7% | ⚠️ CRITICAL |
| Send_Command | 928.600 ns | 1320.500 ns | +42.2% | ⚠️ CRITICAL |
...
| Bulk_Publish_Notifications | 263,997 B | 0 B | -100.0% | 55.0/2.5 | ✅  |
| Bulk_Send_Commands | 263,997 B | 264,000 B | +0.0% | 50.0/0.0 | ➡️  |
| Create_And_Ask_Queries | 320,000 B | 320,000 B | 0.0% | 62.5/0.0 | ➡️  |
| Create_And_Publish_Notifications | 368,005 B | 368,000 B | -0.0% | 69.4/0.0 | ➡️  |
| Create_And_Send_Commands | 359,915 B | 359,920 B | +0.0% | 68.8/0.0 | ➡️  |
| Store_Command_Results_In_List | 280,125 B | 0 B | -100.0% | 57.5/5.0 | ✅  |
...
- **Current**: 1335.100 ns (304 B allocated)
- **Change**: +37.1%
...
- **Current**: 916.200 ns (40 B allocated)
- **Change**: +43.9%
- **Recommendation**: Fix before merge
...
- **Current**: 913.800 ns (40 B allocated)
- **Change**: +44.3%
- **Recommendation**: Fix before merge
...
- **Current**: 913.200 ns (40 B allocated)
- **Change**: +44.3%
- **Recommendation**: Fix before merge
...
- **Current**: 1336.900 ns (264 B allocated)
- **Change**: +41.7%
- **Recommendation**: Fix before merge
...
- **Current**: 1320.500 ns (0 B allocated)
- **Change**: +42.2%
- **Recommendation**: Fix before merge
