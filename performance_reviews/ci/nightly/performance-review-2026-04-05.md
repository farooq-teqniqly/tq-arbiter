...
**Date**: 2026-04-05 22:47:04 UTC
**Baseline**: 2025-12-07T22:39:09.802928
**Commit**: d962407190394e8198fd77ec54555b35d2b170e3
...
|-----------|----------|---------|--------|--------|
| Ask_Query | 974.000 ns | 1355.500 ns | +39.2% | ⚠️ CRITICAL |
| Create_Command | 636.900 ns | 916.300 ns | +43.9% | ⚠️ CRITICAL |
| Create_Notification | 633.400 ns | 926.900 ns | +46.3% | ⚠️ CRITICAL |
| Create_Query | 633.000 ns | 921.200 ns | +45.5% | ⚠️ CRITICAL |
| Publish_Notification | 943.200 ns | 1314.700 ns | +39.4% | ⚠️ CRITICAL |
| Send_Command | 928.600 ns | 1331.800 ns | +43.4% | ⚠️ CRITICAL |

## Memory Benchmarks

| Benchmark | Baseline | Current | Alloc Change | Gen0/1 | Status |
|-----------|----------|---------|--------------|--------|--------|
| Bulk_Ask_Queries | 231,997 B | 231,997 B | 0.0% | 44.3/0.0 | ➡️  |
| Bulk_Publish_Notifications | 263,997 B | 263,997 B | 0.0% | 50.0/0.0 | ➡️  |
| Bulk_Send_Commands | 263,997 B | 263,997 B | 0.0% | 95.0/0.0 | ➡️  |
...
- **Current**: 1355.500 ns (186 B allocated)
- **Change**: +39.2%
...
- **Current**: 916.300 ns (487 B allocated)
- **Change**: +43.9%
- **Recommendation**: Fix before merge
...
- **Current**: 926.900 ns (40 B allocated)
- **Change**: +46.3%
- **Recommendation**: Fix before merge
...
- **Current**: 1314.700 ns (264 B allocated)
- **Change**: +39.4%
- **Recommendation**: Fix before merge
...
- **Current**: 1331.800 ns (344 B allocated)
- **Change**: +43.4%
- **Recommendation**: Fix before merge
